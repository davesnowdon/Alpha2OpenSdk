...
public class DefaultPrettyPrinter implements PrettyPrinter {
   ...
   public void indentArraysWith(Indenter i) {
      this._arrayIndenter = (Indenter)(i == null ? new DefaultPrettyPrinter.NopIndenter() : i);
   }

   public void indentObjectsWith(Indenter i) {
      this._objectIndenter = (Indenter)(i == null ? new DefaultPrettyPrinter.NopIndenter() : i);
   }
   ...
   public static class Lf2SpacesIndenter implements Indenter {
      ...
      public void writeIndentation(JsonGenerator jg, int level) throws IOException, JsonGenerationException {
         ...
         for(level += level; level > 64; level -= SPACES.length) {
            jg.writeRaw((char[])SPACES, 0, 64);
         }

         jg.writeRaw((char[])SPACES, 0, level);
      }
