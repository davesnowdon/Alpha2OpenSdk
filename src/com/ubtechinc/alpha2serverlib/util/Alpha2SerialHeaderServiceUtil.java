...
public class Alpha2SerialHeaderServiceUtil implements ServiceConnection {
   ...
   public static void initCommonInstance(Context context, Alpha2SerialPortHeaderOnRcvListener listener) {
      mCommonInstance = new Alpha2SerialHeaderServiceUtil(context, listener);
   }
   ...
   public Alpha2SerialHeaderServiceUtil(Context context, Alpha2SerialPortHeaderOnRcvListener listener) {
      ...
      this.mCallIntent = new Intent("com.ubtechinc.services.AlphaSerialPortHeaderServices");
      this.mCallIntent.setPackage("com.ubtechinc.alpha2services");
      this.mRcvListener = new Alpha2SerialHeaderServiceUtil.Alpha2SerialPortRcvClientImpl();
   ...
   private class Alpha2SerialPortRcvClientImpl extends IAlpha2SerialPortRcvClient.Stub {
      ...
      public void onListenSerialPortRcvData(byte[] bytes, int len) throws RemoteException {
         if (Alpha2SerialHeaderServiceUtil.this.mCientListener != null) {
            Alpha2SerialHeaderServiceUtil.this.mCientListener.onListenSerialPortHeaderRcvData(bytes, len);
         }
