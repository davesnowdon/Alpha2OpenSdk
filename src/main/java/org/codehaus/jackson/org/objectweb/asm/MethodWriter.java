      ...
      if (this.M == 0) {
         ...
         while(var5 != null) {
            ...
            for(; var9 != null; var9 = var9.c) {
               var6 = var9.b;
               if ((var6.a & 8) == 0) {
                  var6.f = var9.a == 2147483647 ? 1 : var20 + var9.a;
                  var6.a |= 8;
                  var6.k = var5;
                  var5 = var6;
               }
   ...
   final void a(ByteVector var1) {
      ...
      if (this.h != 0) {
         ...
         if (this.r.b > 0) {
            ...
            if (this.v != null) {
               boolean var6 = (this.b.b & '\uffff') >= 50;
               var1.putShort(this.b.newUTF8(var6 ? "StackMapTable" : "StackMap"));
