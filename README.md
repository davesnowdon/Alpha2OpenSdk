 ...
 * @return  
 */
public API_EEROR_CODE speech_StartTTS (String language, String text, String strVoicName)

/**
 * Stop broadcasting TTS message 
 * @return  
 */
public API_EEROR_CODE speech_StopTTS() 

public API_EEROR_CODE speech_StartTTS (String text, String strVoicName)

public API_EEROR_CODE speech_StartTTS (String text)
```
 ...
 */
 public API_EEROR_CODE speech_initGrammar(String strGramma, IAlpha2SpeechGrammarInitListener listener)
 ...
 * @return  API_EEROR_CODE
 */
 public API_EEROR_CODE speeh_startGrammar(IAlpha2SpeechGrammarListener listener) 
 ...
 * @return  API_EEROR_CODE
 */
public API_EEROR_CODE speech_setRecognizedLanguage(String strLanguage) 
 ...
 * @return  API_EEROR_CODE
 */
public API_EEROR_CODE speech_understandText(String strText,
 ...
 * @return  API_EEROR_CODE
 */
public API_EEROR_CODE action_getActionList(IAlpha2ActionListListener listener)
 ...
 * @return API_EEROR_CODE
 */
public API_EEROR_CODE action_PlayActionName(String actionName)

/**
 * Stop performing action
 * @return API_EEROR_CODE
 */
public API_EEROR_CODE action_StopAction()
```
 ...
 * @return  API_EEROR_CODE
 */
public API_EEROR_CODE chest_SendFreeAngle(int[] data, short time)
 ...
 * @return  API_EEROR_CODE
 */
public API_EEROR_CODE chest_SendOneFreeAngle(byte id, int angle, short time)
```
 ...
 * @return  API_EEROR_CODE
 */
public API_EEROR_CODE header_startEarLED(int color, int bright, int rightEar, int leftEar,
